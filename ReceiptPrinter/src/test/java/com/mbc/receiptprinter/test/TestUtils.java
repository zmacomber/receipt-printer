...
public class TestUtils {
	...
	static void deleteAllReceipts() throws Exception {
		...
		String dataFilePath = FilePaths.RECEIPT_DATA.getPath();
	...
	static void deleteAllDesignations() throws Exception {
		...
		DeleteDao deleteDao = new DeleteDao();
		String dataFilePath = FilePaths.DESIGNATION_DATA.getPath();
	...
	static void deleteAllAddresses() throws Exception {
		...
		DeleteDao deleteDao = new DeleteDao();
		String dataFilePath = FilePaths.ADDRESS_DATA.getPath();
