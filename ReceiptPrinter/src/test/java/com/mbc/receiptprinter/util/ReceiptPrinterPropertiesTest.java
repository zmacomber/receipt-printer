...
public class ReceiptPrinterPropertiesTest {
	...
	public void testGetProperty() throws Exception {
		...
		Iterator<File> receiptPrinterSourceFiles = FileUtils.iterateFiles(new File(RECEIPT_PRINTER_SOURCE_DIR), null, true);
		
		while(receiptPrinterSourceFiles.hasNext()) {
			List<String> fileLines = FileUtils.readLines(receiptPrinterSourceFiles.next());
